...
export class ProfileComponent {
  ...
  onSubmit(form: 'profile' | 'account') {
    ...
    const pristineCheck = isProfile
      ? this.areAllFieldsPristine('profile')
      : this.areAllFieldsPristine('account');
    ...
    const confirmMessage = isProfile
      ? '¿Desea modificar sus datos de perfil?'
      : '¿Desea modificar sus datos de cuenta?';
